Feature: Rubik's cube
    ...
    Scenario: Customize the rubik's cube
        Given the user is able to custom each face of the cube
        And the user select "Elic", "Samuel", "Mingo", "LQ", "Youssef", "Karl" and "Sebastien"


    Scenario: Revert action of rubik's cube
        When the user visits the "home" page


    Scenario: Shuffle the rubik's cube
        When the user visits the "home" page
